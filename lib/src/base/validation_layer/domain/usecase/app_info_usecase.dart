...
import 'package:fresh_fashion_mobile/src/base/validation_layer/data/datasource/app_info_datasource.dart';
...
class AppInfoUseCase extends AppInfoUseCaseInterface {
  ...
  Future<Either<Failure, String>> getSupportedVersion() async {
    Either<APIServiceException, String> supportedVersion = await _repository.getSupportedVersion();
    Failure? failure;
